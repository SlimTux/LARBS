...
10. Novices who want to use and learn about a leet hackerman computer setup like those in the movies for either efficiency or looking cool.
11. Lazy-ass people like me.
...
```fish
curl -LO https://github.com/SlimTux/LARBS/larbs.sh
sh larbs.sh
```
...
- No snaps or appimages or Mac-lite garbage. GNU/Linux the way it's supposed to be.(maybe some flatpaks)
...
- [lf](/lf) -- file manager
- [betterbird](/neomutt) -- email
- [abook](/abook) -- extensible address book
- [nuclear](/ncmpcpp) -- music
- [newsboat](newsboat) -- RSS feeds and news
- [nvtop](htop) -- to look cool in screencaps... err... system monitor
- [ImPlay](/mpv) -- video player
...
- The many illustrative videos on [SlimTux's YouTube channel](https://youtube.com/SlimTux), some of which are easily watchable in LARBS by pressing <kbd>super + F2</kbd>.
- The documentation on the <a href="https://github.com/lukesmithxyz/voidrice">Github</a> page.
- Eventually I shall do my own documentation.
