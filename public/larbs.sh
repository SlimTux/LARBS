...
# SlimTux's Auto Rice Boostrapping Script (LARBS)
# by SlimTux Smith <luke@lukesmith.xyz>
# License: GNU GPLv3

### OPTIONS AND VARIABLES ###

dotfilesrepo="https://github.com/SlimTux/dotfiles.git"
progsfile="https://raw.githubusercontent.com/SlimTux/LARBS/master/static/progs.csv"
aurhelper="paru"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to SlimTux's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-SlimTux" 10 60
...
preinstallmsg() {
	whiptail --title "Let's get this party started!" --yes-button "Let's go!" \
		...
		--yesno "The rest of the installation will now be totally automated, so you can sit back and relax.\\n\\nIt will take about 10 minustes, but when done, you can relax even more with your complete system.\\n\\nNow just press <Let's go!> and the system will begin installation!" 13 60 || {
		clear
		exit 1
	}
}
...
EXTENSION-PATHS() {
	# TODO remove shortcuts error message
	# create the right extensions.
	whiptail --infobox "Creating directories for extensions..." 7 60
	mkdir -p "/home/$name/Download/Extensions"
	mkdir -p "/home/$name/Documents/Extensions"
	mkdir -p "/home/$name/Videos/Extensions"
	mkdir -p "/home/$name/Pictures/Extensions"
	mkdir -p "/home/$name/Download/Extensions/apk"
	mkdir -p "/home/$name/Download/Extensions/tar"
	mkdir -p "/home/$name/Download/Extensions/zip"
	mkdir -p "/home/$name/Documents/Extensions/pdf"
	mkdir -p "/home/$name/Documents/Extensions/txt"
	mkdir -p "/home/$name/Documents/Extensions/md"
	mkdir -p "/home/$name/Documents/Extensions/epub"
	################################curl -Ls "https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim" >  "/home/$name/.config/nvim/autoload/plug.vim"
	chown -R "$name:wheel" "/home/$name/Download"
	chown -R "$name:wheel" "/home/$name/Documents"
}

astronvim() {
	# TODO remove shortcuts error message
	# Installs vim plugins.
	whiptail --infobox "Installing AstroNeovim..." 7 60
	mkdir -p "/home/$name/.config/nvim/init.lua"
	curl -Ls "https://raw.githubusercontent.com/SlimTux/dotfiles/master/main-machine/.config/nvim/init.lua" >  "/home/$name/.config/nvim/autoload/init.lua"
	chown -R "$name:wheel" "/home/$name/.config/nvim"
	doas -u "$name" nvim -c "PlugInstall|q|q"
}
...
installffaddons(){
	...
	IFS=' '
	doas -u "$name" mkdir -p "$pdir/extensions/"
	for addon in $addonlist; do
		addonurl="$(curl --silent "https://addons.mozilla.org/en-US/firefox/addon/${addon}/" | grep -o 'https://addons.mozilla.org/firefox/downloads/file/[^"]*')"
		file="${addonurl##*/}"
		doas -u "$name" curl -LOs "$addonurl" > "$addontmp/$file"
		id="$(unzip -p "$file" manifest.json | grep "\"id\"")"
		id="${id%\"*}"
		id="${id##*\"}"
		doas -u "$name" mv "$file" "$pdir/extensions/$id.xpi"
	done
}
...
echo "%wheel ALL=(ALL:ALL) ALL" >/etc/sudoers.d/00-larbs-wheel-can-doas
...
echo "Defaults editor=/usr/bin/nvim" >/etc/sudoers.d/02-larbs-vidoas-editor
